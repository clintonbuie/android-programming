package bignerdranch.android.nerdlauncher;
...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ActivityHolder(View itemView) {
            super(itemView);
            mImageView = (ImageView) itemView.findViewById(R.id.custom_list_imageview);
            mNameTextView = (TextView) itemView.findViewById(R.id.custom_list_textview);
